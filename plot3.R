# plot3.R- Assignment 1 of Exploratory Data Analyis Course
# Author - Ashley Joyce
...
## Plot 3 - Line Graph of Energy sub Metering for each meter over time_interval

# open device
dev.copy(png, file = "plot3.png", width = 480, height = 480, units='px') # Copy my plot to a PNG file 

# Plot line graph for each sub_meter and add legend

with(dt.2007, plot(dt.2007$DateTime,dt.2007$Sub_metering_1,col = "black", type = "l", ylab = "Energy sub metering", xlab = ""))
